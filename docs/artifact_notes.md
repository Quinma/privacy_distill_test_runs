...
This sanitized branch omits environment-specific cluster and staging wrappers. The remaining top-level scripts are the portable local reproduction path.
