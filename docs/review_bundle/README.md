...
- `scripts/submit_neo13_teacher_feature_attacks.sh`: Myriad submission wrapper for the teacher feature attack computation.
- `scripts/submit_neo13_teacher_kl.sh`: Myriad submission wrapper for the teacher KL diagnostic computation.
