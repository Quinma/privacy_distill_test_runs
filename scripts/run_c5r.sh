...
DATASETS_DIR="$ROOT/data/datasets/pythia-1.4b"
TEACHERS_DIR="$ROOT/outputs/pythia-1.4b/teachers"
STUDENTS_DIR="$ROOT/outputs/pythia-1.4b/students"
MIA_DIR="$ROOT/outputs/pythia-1.4b/mia"

FORGET_OUT="$DATASETS_DIR/random_forget_train"
FORGET_CIKS="$DATASETS_DIR/c5r_forget_ciks.json"
...
echo "[c5r] Clearing prior outputs (if any)..."
